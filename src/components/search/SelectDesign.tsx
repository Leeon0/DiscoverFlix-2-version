...
export default function SelectDesign({
    ...
    /**
     * Handles the selection of a value from the dropdown and navigates to the appropriate URL.
     * 
     * @param {string | number} id - The ID of the selected option.
     */
