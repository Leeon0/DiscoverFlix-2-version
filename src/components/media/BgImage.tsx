...
/*
BgImage component displays the background image for a movie or series.
It uses poster_path for small screens and backdrop_path for larger screens.
*/ 
