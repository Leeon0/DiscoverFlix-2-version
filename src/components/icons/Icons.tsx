...
/*
export const Logo = () => (
    <svg width='35' height='35' xmlns='http://www.w3.org/2000/svg' fill='yellow'>
        <circle cx='5' cy='8' r='7' />
        <circle cx='15' cy='8' r='7' />

        <circle cx='5' cy='18' r='7' />
        <circle cx='15' cy='18' r='0' />
        <circle cx='25' cy='18' r='3' />

        <circle cx='5' cy='28' r='7' />
        <circle cx='15' cy='28' r='7' />
    </svg>
)
*/
export const Logo = () => (
    <svg width='35' height='35' xmlns='http://www.w3.org/2000/svg' fill='none' stroke='yellow' stroke-width='5'>
